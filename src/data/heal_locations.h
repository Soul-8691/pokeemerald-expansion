static const struct HealLocation sHealLocations[] =
{
    ...
    [SPAWN_KINNOW_ISLAND - 1] = {MAP_GROUP(KINNOW_ISLAND), MAP_NUM(KINNOW_ISLAND), 18, 17},
};

static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE_2F - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE_2F - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_PETALBURG_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_SLATEPORT_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_MAUVILLE_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_RUSTBORO_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_FORTREE_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_LILYCOVE_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_MOSSDEEP_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_SOOTOPOLIS_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_EVER_GRANDE_CITY - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_LITTLEROOT_TOWN_BRENDANS_HOUSE - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_LITTLEROOT_TOWN_MAYS_HOUSE - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_OLDALE_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_DEWFORD_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_LAVARIDGE_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_FALLARBOR_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_VERDANTURF_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_PACIFIDLOG_TOWN - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_EVER_GRANDE_CITY_POKEMON_LEAGUE - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST - 1] = {MAP_GROUP(UNDEFINED), MAP_NUM(UNDEFINED)},
    [SPAWN_KINNOW_ISLAND - 1] = {MAP_GROUP(KINNOW_ISLAND), MAP_NUM(KINNOW_ISLAND)},
};
...
static const u8 sWhiteoutRespawnHealerNpcIds[] =
{
    ...
    [HEAL_LOCATION_SOUTHERN_ISLAND_EXTERIOR - 1] = 1,
    [HEAL_LOCATION_BATTLE_FRONTIER_OUTSIDE_EAST - 1] = 1,
    [SPAWN_KINNOW_ISLAND - 1] = 1,
};
